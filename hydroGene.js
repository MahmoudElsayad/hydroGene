...
var hydroGene = function(seq1,seq2) {
  ...
  var visual = makeArray((seq1.length/3),'---');

  var __result = {1:1, 2:1, 4:1, 3:2, 5:2, 6:2, 7:3};
  ...
  Seq.prototype.align = function(tBuffer) {
    ...
    for (var i = 0; i < queryView.length; i++) {
      ...
      if (result != 0) {
        visual[index] = __2BytesToProtein[queryView[i]];
        searchView[index] = 0;
      }
  ...
  default:
    ...
    // console.log('Result for comparing ' + __2BytesToProtein[num1] + "  -->" + num1 + " and " + __2BytesToProtein[num2] + "  -->" + num2  + " is: " + __result[matches] );
    // return __result[matches];
    // return result;
  };
  ...
  var res = {
    ...
    seqAlignment1: seq1,
    seqAlignment2: visual.toString().replace(/,/gi,"")
